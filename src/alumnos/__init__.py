...
Descripción:
Inicializador del paquete de la aplicación Alumnos.
Gestiona el ciclo de vida de alumnos desde preinscripción hasta graduación,
integrando con sistemas externos (Teams, Moodle, SIAL).
