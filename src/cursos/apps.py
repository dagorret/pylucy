"""
Nombre del Módulo: apps.py

Descripción:
Configuración de la aplicación Cursos de Ingreso.
Define la configuración de la app Django para gestión de cursos.
...
class CursosConfig(AppConfig):
    ...
    name = "cursos"
    verbose_name = "Cursos de Ingreso"
