...
DEVEL = int(os.environ.get("DEVEL", "0"))  # 0 por defecto
...
SECRET_KEY = 'django-insecure-g2h_(rha6*9d0*1p03sq1-o)w-1d!wf4$#$c2r4)&wc941v@ds'
...
DATABASES = {
    "default": {
        ...
        "NAME": env("DB_NAME", default="appdb"),
